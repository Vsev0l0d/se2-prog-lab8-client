# se2-prog-lab8-client
[Сервер](https://github.com/MrAureliuss/se2-prog-lab8-server)

### Доработать программу из [лабораторной работы №7](https://github.com/Vsev0l0d/se2-prog-lab7-server) следующим образом:
